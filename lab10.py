...
class Speech:
    def __init__(self):
        self.tts = pyttsx3.init(driverName='nsss')  
...
class Recognize:
    def __init__(self, path):
        ...
        # model = vosk.Model('/Users/elizavetas/Downloads/vosk-model-small-ru-0.22')
...
if __name__ == "__main__":
    rec = Recognize('/Users/elizavetas/Downloads/vosk-model-small-ru-0.22')
    text_gen = rec.listen()
    rec.stream.stop_stream()
    speak("Голосовой ассистент активирован. Команды: факт, следующий, прочитать, записать, удалить, прощаюсь")
    time.sleep(0.5)
